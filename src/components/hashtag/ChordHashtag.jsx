...
class ChordHashtag extends Component {
  ...
  componentDidMount() {
    Api.getAllChordData().then(res => {
      this.setState({
        accountMa: res[2].data.apiData.chord.data,
        competitorMa: res[3].data.apiData.chord.data,
        isLoading: false,
      });
    });
  }
    ...
    return (
      <div className="container-charts chord-charts">
        ...
        {!this.state.isLoading && (
          <React.Fragment>
            <Chart
              chartTitle="Quali sono gli hashtag che sono stati citati insieme nello stesso tweet di un account Luiss?"
              doesSelectExist
            ...
            <Chart
              chartTitle="Quali sono gli hashtag che sono stati citati insieme nello stesso tweet di un competitor Luiss?"
              doesSelectExist
              selectOptions={['5', '10', '20', '30', '40', '50']}
              selectedOption="5"
              graphExplanation={graphExplanation[3]}
